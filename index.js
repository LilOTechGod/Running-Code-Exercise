...
// CODE HERE
const total = netflix + hulu + disney + youTubePrem + peacock;
console.log(total);
...
// CODE HERE
const newTotal = netflix + hulu + disney + youTubePrem + peacock;
